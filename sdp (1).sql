...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2024 at 11:21 AM
...
--
ALTER TABLE `memory`
  ADD CONSTRAINT `memory_ibfk_1` FOREIGN KEY (`quizID`) REFERENCES `quizzess` (`quizID`);

--
-- Constraints for table `results`
--
ALTER TABLE `results`
  ADD CONSTRAINT `results_ibfk_1` FOREIGN KEY (`quizID`) REFERENCES `quizzess` (`quizID`),
  ADD CONSTRAINT `results_ibfk_2` FOREIGN KEY (`userID`) REFERENCES `users` (`user_id`);

--
-- Constraints for table `sqlgame`
--
ALTER TABLE `sqlgame`
  ADD CONSTRAINT `sqlgame_ibfk_1` FOREIGN KEY (`quizID`) REFERENCES `quizzess` (`quizID`);
COMMIT;
