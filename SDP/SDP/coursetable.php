...
<form action="coursetable.php" method="POST" style="margin-bottom: 20px;"  Id="search_f">
...
<table id="result" class="common-table" style="border-collapse: collapse;">
    <tr class="search-user" style="height: 75px;">
        ...
        <th colspan="1" class="right-align"><a href="coursetable.php" class="button" style="text-decoration: none;">Back</a></th>
    </tr>
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo '<td>' . (strlen($row['img']) > 30 ? substr($row['img'], 0, 30) . '...' : $row['img']) . '</td>';
        echo '<td>' . $row['file'] . '</td>';
        echo '<td><a href="#" onclick="openEditModal(' . $row['courseid'] . ')"><img src="edit.png" alt="Edit" width="40" height="30"></a><span class="space">&nbsp&nbsp;</span>';
        echo '<a onclick="return confirm(\'Delete this record?\')" href="deletecourse.php?courseid=' . $row['courseid'] . '"><img src="delete.png" alt="Edit" width="25" height="28"></a></td>';
        echo '</tr>';
    }
    ?>
</table>
...
<table id="register" class="common-table" style="border-collapse: collapse;">
    <tr class="manage-user" style="height: 75px;">
        <th colspan="4" style="font-size:30px; padding-top: 0; padding-bottom: 0; ">Manage course</th>
        <th colspan="1"><a href="uploadcourse.php" class="button" style="text-decoration: none; width: 100px;">Add Course</a></th>
    </tr>
    <tr style="height: 50px; font-size: 15px;">
        <th>Name</th>
        <th>Description</th>
...
<script>
    function openEditModal(courseid) {
        ...
        xhr.open('GET', 'editcourse.php?courseid=' + courseid, true);
        xhr.send();
