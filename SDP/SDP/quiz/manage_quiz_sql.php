...
<table id="sqlgame" class="common-table" style="border-collapse: collapse;">
    <tr class="manage-user" style="height: 75px;">
        <th colspan="2" style="font-size:30px; padding-top: 0; padding-bottom: 0; ">Manage SQL Quiz</th>
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo '<a onclick="return confirm(\'Delete this record?\')" href="manage_quiz_sql_delete.php?questionID=' . $row['questionID'] . '&quizID='. $quizID .'"><img src="delete_button.png" alt="Edit" width="25" height="28"></a></td>';
        echo '</tr>';
    }echo '</tr>';
    ?>
</table>
