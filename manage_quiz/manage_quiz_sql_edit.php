...
<body>
    ...
    if(isset($_GET['questionID'])) {
        ...
        if(mysqli_num_rows($result) == 1) {
            ...
            echo '<input type="text" name="questionText" value="' . $row['questionText'] . '"><br><br>';
            echo '<label for="name">Table Reference:</label>';
            echo '<input type="text" name="tableReference" value="' . $row['tableReference'] . '"><br><br>';
            echo '<label for="name">Question Output:</label>';
            echo '<input type="text" name="questionOutput" value="' . $row['questionOutput'] . '"><br><br>';
