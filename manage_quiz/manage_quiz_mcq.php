...
if (isset($_POST['search'])) {
    $search = $_POST['search'];
    $query = "SELECT * FROM mcq WHERE question LIKE '%$search%' OR questionID LIKE '%$search%'";
...
<form action="manage_quiz_mcq.php" method="POST" style="margin-bottom: 20px;" id="search_f">
...
<table id="result" class="common-table" style="border-collapse: collapse;">
    <tr class="search-user" style="height: 75px;">
        ...
        <th colspan="1"><a href="manage_quiz_mcq.php" class="button" style="text-decoration: none; margin-right:64px; margin-top:18.5px; ">Back</a></th>
    </tr>
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo '<a onclick="return confirm(\'Delete this record?\')" href="manage_quiz_mcq_delete.php?questionID=' . $row['questionID'] . '"><img src="delete_button.jpg" alt="Edit" width="25" height="28"></a></td>';
        echo '</tr>';
    }echo '</tr>';
    ?>
</table>
...
<?php
    ...
    $result = mysqli_query($con, "SELECT * FROM mcq");
...
<table id="quizzes" class="common-table" style="border-collapse: collapse;">
    <tr class="manage-user" style="height: 75px;">
        <th colspan="3" style="font-size:30px; padding-top: 0; padding-bottom: 0; ">Manage MCQ Quiz</th>
        <th colspan="1"><a href="manage_quiz_mcq_add.php" class="button" style="text-decoration: none; ">Add Questions</a></th>
    </tr>
    <tr style="height: 50px; font-size: 15px;">
        <th>Question</th>
        <th>Answer Options</th>
