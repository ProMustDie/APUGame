...
<table id="quizzes" class="common-table" style="border-collapse: collapse;">
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo '<a onclick="return confirm(\'Delete this record?\')" href="manage_quiz_mcq_delete.php?questionID=' . $row['questionID'] . '&quizID='. $quizID .'"><img src="delete_button.jpg" alt="Edit" width="25" height="28"></a></td>';
        echo '</tr>';
    }echo '</tr>';
    ?>
</table>
