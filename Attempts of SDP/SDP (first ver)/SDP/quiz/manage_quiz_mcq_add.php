    ...
    <section>
        <div class="form-box">
            <div class="form-value">
                <form Id="pythonbasics" name="question" action="manage_quiz_mcq_add.php?quizID=<?php echo $quizID; ?>" method="POST">
                    <h2>Add Question</h2>
                    <div class="inputbox">
                        <input type="text" name="question" Id="question"  autocomplete="off" required>
                    ...
                    <p><a href="manage_quiz_mcq.php?quizID=<?php echo $quizID; ?>" class="back">Back</a></p>
