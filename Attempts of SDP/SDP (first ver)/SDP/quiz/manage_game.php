...
if (isset($_POST['search'])) {
    $search = $_POST['search'];
    $sql = "SELECT * FROM quizzes INNER JOIN user_register ON quizzes.Id = user_register.Id WHERE name LIKE '%$search%'";
...
<?php
} else { $sql = "SELECT * FROM quizzes INNER JOIN user_register ON quizzes.Id = user_register.Id";
    $result = $con->query($sql);    
