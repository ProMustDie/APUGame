...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO html (title, description, backimg, file) VALUES 
            ('$title', '$description', '$backimg', '$file')";

    if (mysqli_query($con, $sql)) {
        echo '<script type="text/javascript">
                alert("Added successfully!");
                window.location = "htmltable.php"; 
              </script>';
        exit();
    } else {
        ...
        echo '<script type="text/javascript">
                ...
                window.location = "uploadhtml.php";
              </script>';
        exit();
    }
}
    ...
    <section>
        <div class="form-box">
            <div class="form-value">
                <form pythonid="html" name="html" action="uploadhtml.php" method="POST">
                    <h2>Add Html</h2>
                    <div class="inputbox">
                        <input type="text" name="title" htmlid="title"  autocomplete="off" required>
                        <label for="">Title</label>
                    </div>          
                    <div class="inputbox">
                        <input type="text" name="description" htmlid="description"  autocomplete="off" required>
                        <label for="">Description</label>
                    </div>  

                    <label for="">Backgroung Image</label>
                    <div class="inputbox">
                        <input type="file" name="backimg" htmlid="backimg"  autocomplete="off" required>
                    </div>

                    <label for="">File</label>
                    <div class="inputbox">
                        <input type="file" name="file" htmlid="file"  autocomplete="off" required>
                    </div>

                    <button type="submit" class="class">Add Chp</button><br><br>
                    <p><a href="htmltable.php" class="back">Back</a></p>
