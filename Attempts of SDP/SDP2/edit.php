...
<body>
    ...
    if(isset($_GET['pythonid'])) {
        ...
        if(mysqli_num_rows($result) == 1) {
            ...
            echo '<h1>Edit Python</h1><br><hr><br>';
            echo '<form action="save edit.php" method="POST">';
            echo '<input type="hidden" name="pythonid" value="' . $row['pythonid'] . '">';
