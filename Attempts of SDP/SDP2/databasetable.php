...
if (isset($_POST['search'])) {
    $search = $_POST['search'];
    $query = "SELECT * FROM db WHERE title LIKE '%$search%'";
    $result = mysqli_query($con, $query);
?>

<form action="databasetable.php" method="POST" style="margin-bottom: 20px;"  Id="search_f">
...
<table id="result" class="common-table" style="border-collapse: collapse;">
    <tr class="search-user" style="height: 75px;">
        ...
        <th colspan="1" class="right-align"><a href="databasetable.php" class="button" style="text-decoration: none;">Back</a></th>
    </tr>
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo '<td>' . $row['file'] . '</td>';
        echo '<td><a href="#" onclick="openEditModal(' . $row['databaseid'] . ')"><img src="edit.png" alt="Edit" width="40" height="30"></a><span class="space">&nbsp&nbsp;</span>';
        echo '<a onclick="return confirm(\'Delete this record?\')" href="deletedb.php?databaseid=' . $row['databaseid'] . '"><img src="delete.png" alt="Edit" width="25" height="28"></a></td>';
        echo '</tr>';
    }
    ?>
</table>
...
<table id="register" class="common-table" style="border-collapse: collapse;">
    <tr class="manage-user" style="height: 75px;">
        <th colspan="4" style="font-size:30px; padding-top: 0; padding-bottom: 0; ">Manage Database Chapter</th>
        <th colspan="1"><a href="uploaddatabase.php" class="button" style="text-decoration: none; width: 100px;">Add Chp</a></th>
    </tr>
    <tr style="height: 50px; font-size: 15px;">
        <th>Title</th>
        <th>Description</th>
...
<script>
    function openEditModal(databaseid) {
        ...
        xhr.open('GET', 'editdb.php?databaseid=' + databaseid, true);
        xhr.send();
