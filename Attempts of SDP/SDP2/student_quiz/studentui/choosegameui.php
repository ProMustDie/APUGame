    ...
    <div class="header">
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><a href="choosegametype.html">Games</a></li>
...
if (isset($_GET['button'])) {
  ...
  switch ($button) {
      case 'MCQ':
          $sql = "SELECT * FROM quizzes WHERE quizzes.gametype='MCQ'";
          break;
      case 'Memory Game':
          $sql = "SELECT * FROM quizzes WHERE quizzes.gametype='memory'";
          break;
      case 'Rearranging the Words':
          $sql = "SELECT * FROM quizzes WHERE quizzes.gametype='rearrange'";
          break;
      default:
