...
<title>View Discussion Python</title>
...
try {
    ...
    $stmt = $pdo->query("SELECT * FROM discussion");

    ?>

    <table id="register" class="common-table" style="border-collapse: collapse;">
    <tr class="manage-user" style="height: 75px;">
        <th colspan="5" style="font-size:30px; padding-top: 0; padding-bottom: 0; ">Manage Python User</th>
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo '<td><a onclick="return confirm(\'Delete this record?\')" href="deleteforumpython.php?id='.$row['id'].'"><img src="image/bin.png" alt="Delete" style="width:20px;height:20px;"></a></td>';
