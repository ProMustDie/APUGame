...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO db (title, description, backimg, file) VALUES 
            ('$title', '$description', '$backimg', '$file')";

    if (mysqli_query($con, $sql)) {
        echo '<script type="text/javascript">
                alert("Added successfully!");
                window.location = "databasetable.php"; 
              </script>';
        exit();
    } else {
        ...
        echo '<script type="text/javascript">
                ...
                window.location = "uploaddatabase.php";
              </script>';
        exit();
    }
}
    ...
    <section>
        <div class="form-box">
            <div class="form-value">
                <form databaseid="db" name="db" action="uploaddatabase.php" method="POST">
                    <h2>Add Database</h2>
                    <div class="inputbox">
                        <input type="text" name="title" databaseid="title"  autocomplete="off" required>
                        <label for="">Title</label>
                    </div>          
                    <div class="inputbox">
                        <input type="text" name="description" databaseid="description"  autocomplete="off" required>
                        <label for="">Description</label>
                    </div>  

                    <label for="">Backgroung Image</label>
                    <div class="inputbox">
                        <input type="file" name="backimg" databaseid="backimg"  autocomplete="off" required>
                    </div>

                    <label for="">File</label>
                    <div class="inputbox">
                        <input type="file" name="file" databaseid="file"  autocomplete="off" required>
                    </div>

                    <button type="submit" class="class">Add Chp</button><br><br>
                    <p><a href="databasetable.php" class="back">Back</a></p>
