...
<table id="result" class="common-table" style="border-collapse: collapse;">
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo '<td><a href="#" onclick="openEditModal(' . $row['user_id'] . ')"><img src="edit_button.jpg" alt="Edit" width="40" height="30"></a><span class="space">&nbsp&nbsp;</span>';
        echo '<a onclick="return confirm(\'Delete this record?\')" href="manage_user_delete.php?user_id=' . $row['user_id'] . '"><img src="delete_button.jpg" alt="Edit" width="25" height="28"></a></td>';
        echo '</tr>';
    }
    ?>
</table>
...
<table id="user_register" class="common-table" style="border-collapse: collapse;">
    <tr class="manage-user" style="height: 75px;">
        <th colspan="4" style="font-size:30px; padding-top: 0; padding-bottom: 0; ">Manage User</th>
...
<script>
    function openEditModal(userId) {
        ...
        xhr.open('GET', 'manage_user_edit.php?user_id=' + userId, true);
        xhr.send();
