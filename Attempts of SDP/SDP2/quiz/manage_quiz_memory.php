...
$quizID = $_GET['quizID'];
    ...
    $result = mysqli_query($con, "SELECT * FROM memory WHERE quizID = $quizID");
...
<p><a href="../quiz/manage_game.php" class="back"><-Back</a></p>
<table id="memory" class="common-table" style="border-collapse: collapse;">
    <tr class="manage-user" style="height: 75px;">
        <th colspan="2" style="font-size:30px; padding-top: 0; padding-bottom: 0; ">Manage Memory Quiz</th>
        <th colspan="1"><a href="manage_quiz_memory_add.php?quizID=<?php echo $quizID ?>" class="button" style="text-decoration: none; margin-right:-15px; margin-top:18px;">Add Questions</a></th>
    </tr>
    </tr>
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo '<a onclick="return confirm(\'Delete this record?\')" href="manage_quiz_memory_delete.php?questionID='.$row['questionID'].'&quizID='. $quizID .'"><img src="delete_button.png" alt="Edit" width="25" height="28"></a></td>';
        echo '</tr>';
    }echo '</tr>';
    ?>
</table>
